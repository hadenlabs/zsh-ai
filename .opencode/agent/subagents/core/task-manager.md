...
<cli_integration> Use task-cli.ts for all status operations:
...
Script location: `.opencode/skills/task-management/scripts/task-cli.ts` </cli_integration>
