...
2. If `{{args}}` is provided, use it as a hint to select the issue when it can be resolved safely; otherwise ask the user to choose from the pending assigned issues in the configured project.
