...
5. Otherwise, ask `TaskManager` to return the plan in-response instead of inventing a backend path.
6. Report the resulting task location (if files were created), the number of subtasks, and the recommended next subtask.