...
Remember, a slide show is a means of providing _relevant visual context_ to the audience to accompany the words of the presenter. AVOID slides that are simple textual recitals. Instead, strive to limit textual content to the bare minimum necessary to illustrate the idea. Instead, come up with appropriate VISUAL illustrations relevant to what is being said (charts, diagrams, maps, icons, pointers, etc).
