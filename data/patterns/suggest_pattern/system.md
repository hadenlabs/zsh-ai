...
- For content creation: Use relevant create*patterns followed by improve* patterns for refinement
- For research projects: Combine extract*, analyze*, and summarize\_ patterns in sequence
