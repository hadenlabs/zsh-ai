<!-- Space: Projects -->
<!-- Parent: ZshAI -->
<!-- Title: Contributing GithubFlow ZshAI -->
<!-- Label: ZshAI -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-ai project on [GitHub](https://github.com/hadenlabs/zsh-ai), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-ai/pulls).
...
To follow the instructions in this guide and start contributing to zsh-ai project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-ai.git
```

Now your **upstream** points to **hadenlabs/zsh-ai**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-ai
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-ai/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
